      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            ...
            <span class="color-text-a">Unreserved Class</span>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div id="property-single-carousel" class="owl-carousel owl-arrow gallery-property">
            <div class="carousel-item-b">
              <img src="images/unr1.jpg" alt="">
            </div>
            <div class="carousel-item-b">
              <img src="images/unr2.jpg" alt="">
            </div>
            <div class="carousel-item-b">
              <img src="images/unr3.jpg" alt="">
            </div>
          </div>
              ...
              <div class="property-summary">
                ...
                <div class="summary-list">
                  <ul class="list">
                    ...
                    <li class="d-flex justify-content-between">
                      <strong>Recommended for long travel:</strong>
                      <span>N</span>
                    </li>
                    <li class="d-flex justify-content-between">
            ...
            <div class="col-md-7 col-lg-7 section-md-t3">
              ...
              <div class="property-description">
                <p class="description color-text-a">
                  Unreserved class is the cheapest of all.
                </p>
        ...
        <div class="col-md-10 offset-md-1">
          ...
          <div class="tab-pane fade show active" id="pills-video" role="tabpanel" aria-labelledby="pills-video-tab">
            <iframe width="100%" height="500" src="https://www.youtube.com/embed/pEXA-aUfz5Y" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
