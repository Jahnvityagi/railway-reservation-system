            ...
            <div class="row">
                <div class="col-md-12 col-lg-8">
                    <div class="title-single-box">
                        ...
                        <span class="color-text-a">Sleeper Class</span>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div id="property-single-carousel" class="owl-carousel owl-arrow gallery-property">
                        <div class="carousel-item-b">
                            <img src="images/slp1.jpg" alt="">
                        </div>
                        <div class="carousel-item-b">
                            <img src="images/slp2.jpg" alt="">
                        </div>
                        <div class="carousel-item-b">
                            <img src="images/slp3.jpg" alt="">
                        </div>
                    </div>
                        ...
                        <div class="col-md-7 col-lg-7 section-md-t3">
                            ...
                            <div class="amenities-list color-text-a">
                                <ul class="list-a no-margin">
                                    <li>72-80 berths</li>
                                    <li>2 manual windows</li>
                                    <li>Hawkers</li>
                                    <li>Non-AC coaches</li>
                                    <li>Economical</li>
                                    <li>8-berths per compartment</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-10 offset-md-1">
                    <div class="tab-pane fade show active" id="pills-video" role="tabpanel" aria-labelledby="pills-video-tab">
                        <iframe width="100%" height="500" src="https://www.youtube.com/embed/V-vgirZoZ2U" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
                </div>
            </div>
        </div>
    </section>
